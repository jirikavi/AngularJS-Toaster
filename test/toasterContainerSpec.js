...
describe('toasterContainer', function () {
    ...
    describe('addToast', function () {
        ...
        it('should allow subsequent duplicates if prevent-duplicates is true and body matches', function () {
            var container = angular.element(
                '<toaster-container toaster-options="{\'prevent-duplicates\': true}"></toaster-container>');
        ...
        it('should not allow subsequent duplicates if prevent-duplicates is false with identical toastId params', function () {
            var container = angular.element(
                '<toaster-container toaster-options="{\'prevent-duplicates\': false}"></toaster-container>');
            ...
            toaster.pop({ type: 'info', title: 'title', body: 'body', toastId: 1, preventDuplicates: true });
            toaster.pop({ type: 'info', title: 'title', body: 'body', toastId: 1, preventDuplicates: true });
